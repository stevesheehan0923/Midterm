...
public abstract class Person implements java.io.Serializable 
{
			...
			Date DOB, String Address, String Phone_number, String Email) throws PersonException
	{
		...
		this.LastName = LastName;
		this.setDOB(DOB);
		Date InvalidBirthDate = new Date(1918, 3, 17);
		if (DOB.before(InvalidBirthDate))
		{
			//DOB OLDER THAN 100 YEARS
			throw new PersonException("Date of birth cannot be more than 100 years old", this);
		}
		...
		{
			throw new PersonException("Phone Number does not have the correct format", this);
		}
	}
